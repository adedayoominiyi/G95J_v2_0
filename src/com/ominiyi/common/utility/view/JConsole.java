...
// Slightly refactored to make it more 2012
public abstract class JConsole extends JScrollPane implements GUIConsoleInterface, 
        Runnable, EnterKeyPressedListener {
    ...
    public JConsole(InputStream cin, OutputStream cout) {
        ...
        text.addKeyListener(new ConsoleKeyListener());
        setViewportView(text);

        // create popup	menu
        menu = new JPopupMenu("JConsole	Menu");
        menu.add(new JMenuItem(CUT)).addActionListener(new ConsoleActionListener());
        menu.add(new JMenuItem(COPY)).addActionListener(new ConsoleActionListener());
        menu.add(new JMenuItem(PASTE)).addActionListener(new ConsoleActionListener());

        text.addMouseListener(new ConsoleMouseListener());

        // make	sure popup menu	follows	Look & Feel
        UIManager.addPropertyChangeListener(new ConsolePropertyChangeListener());
    ...
    @Override
    public final void print(Object s, Color color) {
        print(s, null, color);
    }
    ...
    class ConsolePropertyChangeListener implements PropertyChangeListener {
